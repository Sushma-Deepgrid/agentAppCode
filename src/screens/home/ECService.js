import { StyleSheet, Text, View, TouchableOpacity,ActivityIndicator,
   Linking, Image,TextInput } from 'react-native';
...
import { PropertyId, ServiceName, ServiceId, UserToken,Geofencing,
   DocumentsList,CommentBox,Reload } from '../../../store';
...
// PreviousGeotagging.splice(index,1)
  ...
  console.log("comments",comment)
    ...
    if(PreviousGeotagging === []){
      formData.append("previous_geo_tagging", []);
    }
    else{
      formData.append("previous_geo_tagging", JSON.stringify(PreviousGeotagging));
    }
